...
│  │              │  │              │  │              │          │
│  │ Notebooks &  │  │ Experiment   │  │ Dashboards & │          │
│  │ Development  │  │ Tracking     │  │ Visualization│          │
│  └──────────────┘  └──────────────┘  └──────────────┘          │
│                                                                   │
│  ┌────────────────────────────────────────────────────────┐     │
│  │                  Apache Airflow                          │     │
...
└─────────────────────────────────────────────────────────────────┘
                          ...
                          │
┌─────────────────────────────────────────────────────────────────┐
│               Data Lakehouse Layer (Iceberg)                     │
│    Trino + Spark + PostgreSQL + MinIO + Nessie                  │
└─────────────────────────────────────────────────────────────────┘
```
...
3. **Data** → **Databases** → **+ Database**
4. Select "Trino" and enter connection:
   ```
   trino://trino@trino:8080/iceberg
   ```
5. **Data** → **Datasets** → Import from database
6. **Charts** → **+ Chart** → Select dataset and visualization
7. **Dashboards** → **+ Dashboard** → Add charts
...
```
1. Ingestion: Airbyte/Debezium → Kafka → Flink/Spark → Iceberg
                                                            ↓
